...
public class CoconutMilkFluidType extends FluidType {
	public CoconutMilkFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("minebound:blocks/milk"), FLOWING_TEXTURE = new ResourceLocation("minebound:blocks/milk");
