...
public class HealingWaterFluidType extends FluidType {
	public HealingWaterFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("minebound:blocks/healingwatertex"), FLOWING_TEXTURE = new ResourceLocation("minebound:blocks/healingwatertex");
