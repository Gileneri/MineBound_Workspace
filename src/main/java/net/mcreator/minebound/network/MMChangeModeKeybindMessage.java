...
import net.mcreator.minebound.procedures.MattermanipulatorbetaChangeModeProcedure;
...
public class MMChangeModeKeybindMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MineboundMod.addNetworkMessage(MMChangeModeKeybindMessage.class, MMChangeModeKeybindMessage::buffer, MMChangeModeKeybindMessage::new, MMChangeModeKeybindMessage::handler);
	}
}
