...
import net.mcreator.minebound.item.TarOilItem;
...
public class MineboundModItems {
	...
	public static final RegistryObject<Item> TAR_OIL_BUCKET = REGISTRY.register("tar_oil_bucket", () -> new TarOilItem());
	public static final RegistryObject<Item> BLOCK_ERCHIUS_FUEL = block(MineboundModBlocks.BLOCK_ERCHIUS_FUEL, MineboundModTabs.TAB_ITEMS_AND_ORES);
	public static final RegistryObject<Item> BLOCK_TAR_OIL = block(MineboundModBlocks.BLOCK_TAR_OIL, MineboundModTabs.TAB_ITEMS_AND_ORES);
	public static final RegistryObject<Item> BLOCK_POISON = block(MineboundModBlocks.BLOCK_POISON, MineboundModTabs.TAB_ITEMS_AND_ORES);
	public static final RegistryObject<Item> BLOCK_STICK_SLIME = block(MineboundModBlocks.BLOCK_STICK_SLIME, MineboundModTabs.TAB_ITEMS_AND_ORES);
	public static final RegistryObject<Item> BLOCK_SWAMP_WATER = block(MineboundModBlocks.BLOCK_SWAMP_WATER, MineboundModTabs.TAB_ITEMS_AND_ORES);
	public static final RegistryObject<Item> BLOCK_WATER = block(MineboundModBlocks.BLOCK_WATER, MineboundModTabs.TAB_ITEMS_AND_ORES);
