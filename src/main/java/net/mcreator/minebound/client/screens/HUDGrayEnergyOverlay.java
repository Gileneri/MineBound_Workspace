...
import net.mcreator.minebound.procedures.AllowGrayEnergyUIProcedure;
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (AllowGrayEnergyUIProcedure.execute(entity)) {
			if (HUDDisplayEnergy1Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("minebound:textures/screens/hud_ui_energy_gray_right.png"));
			...
			if (HUDDisplayEnergy2Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("minebound:textures/screens/hud_ui_energy_gray_left.png"));
