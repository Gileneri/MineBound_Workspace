...
import net.mcreator.minebound.procedures.WhenPlayerEntersShipDimensionProcedure;
...
public class SpaceDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("minebound:space"), customEffect));
		}
	}
