...
public class GlassTopperStructureFeature extends Feature<NoneFeatureConfiguration> {
	public static GlassTopperStructureFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GlassTopperStructureFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minebound:glass_topper_structure", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("minebound:glass_topper_structure", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public GlassTopperStructureFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("minebound", "glass_topper"));
		if (template == null)
			return false;
