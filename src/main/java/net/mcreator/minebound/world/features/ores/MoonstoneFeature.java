...
public class MoonstoneFeature extends OreFeature {
	public static MoonstoneFeature FEATURE = null;
	public static Holder<ConfiguredFeature<OreConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new MoonstoneFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("minebound:moonstone", FEATURE,
