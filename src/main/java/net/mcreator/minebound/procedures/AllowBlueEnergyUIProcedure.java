...
public class AllowBlueEnergyUIProcedure {
	public static boolean execute(Entity entity) {
		...
		if ((new Object() {
			...
			public boolean checkGamemode(Entity _ent) {
				...
				|| (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == MineboundModItems.DEBUG_TEST_TOOL.get()) && entity.getPersistentData().getDouble("energyStatus") == 1) {
			shouldDisplay = true;
		}
