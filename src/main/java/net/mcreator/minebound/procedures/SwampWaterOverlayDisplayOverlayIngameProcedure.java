...
public class SwampWaterOverlayDisplayOverlayIngameProcedure {
	public static boolean execute(LevelAccessor world, double x, double z, Entity entity) {
		if (entity == null)
			return false;
		boolean Submerged_swamp_water = false;
		if ((world
				...
				.createLegacyBlock()).getBlock() == MineboundModBlocks.SWAMP_WATER.get()) {
			Submerged_swamp_water = true;
		}
		return Submerged_swamp_water;
	}
}
