...
public class HealingWaterOverlayDisplayOverlayIngameProcedure {
	public static boolean execute(LevelAccessor world, double x, double z, Entity entity) {
		if (entity == null)
			return false;
		boolean IsSubmerged_HealingWater = false;
		IsSubmerged_HealingWater = false;
		if ((world
				...
				.createLegacyBlock()).getBlock() == MineboundModBlocks.HEALING_WATER.get()) {
			IsSubmerged_HealingWater = true;
		}
		return IsSubmerged_HealingWater;
	}
}
