...
public class TaroniMobEntity extends Monster {
	public TaroniMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.TARONI_MOB.get(), world);
	}

	public TaroniMobEntity(EntityType<TaroniMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
