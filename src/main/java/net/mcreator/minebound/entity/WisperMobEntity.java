...
public class WisperMobEntity extends Monster {
	public WisperMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.WISPER_MOB.get(), world);
	}

	public WisperMobEntity(EntityType<WisperMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
