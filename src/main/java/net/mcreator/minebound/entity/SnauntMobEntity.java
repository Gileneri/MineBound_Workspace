...
public class SnauntMobEntity extends Monster {
	public SnauntMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SNAUNT_MOB.get(), world);
	}

	public SnauntMobEntity(EntityType<SnauntMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
