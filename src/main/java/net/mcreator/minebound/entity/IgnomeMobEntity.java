...
public class IgnomeMobEntity extends Monster {
	public IgnomeMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.IGNOME_MOB.get(), world);
	}

	public IgnomeMobEntity(EntityType<IgnomeMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
