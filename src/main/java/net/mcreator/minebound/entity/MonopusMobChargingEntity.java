...
public class MonopusMobChargingEntity extends Monster {
	public MonopusMobChargingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.MONOPUS_MOB_CHARGING.get(), world);
	}

	public MonopusMobChargingEntity(EntityType<MonopusMobChargingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
