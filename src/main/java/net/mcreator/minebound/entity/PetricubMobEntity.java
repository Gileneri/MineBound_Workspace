...
public class PetricubMobEntity extends Monster {
	public PetricubMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.PETRICUB_MOB.get(), world);
	}

	public PetricubMobEntity(EntityType<PetricubMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
