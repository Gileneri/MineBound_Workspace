...
public class ApexMutantMobEntity extends Monster {
	public ApexMutantMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.APEX_MUTANT_MOB.get(), world);
	}

	public ApexMutantMobEntity(EntityType<ApexMutantMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
