...
public class MandrafloraMobEntity extends Monster {
	public MandrafloraMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.MANDRAFLORA_MOB.get(), world);
	}

	public MandrafloraMobEntity(EntityType<MandrafloraMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
