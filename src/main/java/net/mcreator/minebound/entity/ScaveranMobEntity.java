...
public class ScaveranMobEntity extends Monster {
	public ScaveranMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SCAVERAN_MOB.get(), world);
	}

	public ScaveranMobEntity(EntityType<ScaveranMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
