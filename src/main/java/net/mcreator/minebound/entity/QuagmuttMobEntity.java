...
public class QuagmuttMobEntity extends Monster {
	public QuagmuttMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.QUAGMUTT_MOB.get(), world);
	}

	public QuagmuttMobEntity(EntityType<QuagmuttMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
