...
public class SpookitMobEntity extends Monster {
	public SpookitMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SPOOKIT_MOB.get(), world);
	}

	public SpookitMobEntity(EntityType<SpookitMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.FLYING_SPEED, 0.03);
		return builder;
	}
}
