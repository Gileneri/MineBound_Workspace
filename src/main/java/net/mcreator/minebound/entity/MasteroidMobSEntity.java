...
public class MasteroidMobSEntity extends Monster {
	public MasteroidMobSEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.MASTEROID_MOB_S.get(), world);
	}

	public MasteroidMobSEntity(EntityType<MasteroidMobSEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
