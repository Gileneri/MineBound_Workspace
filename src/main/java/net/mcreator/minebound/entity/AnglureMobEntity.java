...
public class AnglureMobEntity extends Monster {
	public AnglureMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.ANGLURE_MOB.get(), world);
	}

	public AnglureMobEntity(EntityType<AnglureMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
