...
public class BobfaeMobEntity extends Monster {
	public BobfaeMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.BOBFAE_MOB.get(), world);
	}

	public BobfaeMobEntity(EntityType<BobfaeMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
