...
public class SmoglinMobEntity extends Monster {
	public SmoglinMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SMOGLIN_MOB.get(), world);
	}

	public SmoglinMobEntity(EntityType<SmoglinMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
