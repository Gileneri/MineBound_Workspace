...
public class CrustoiseMobChargingEntity extends Monster {
	public CrustoiseMobChargingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.CRUSTOISE_MOB_CHARGING.get(), world);
	}

	public CrustoiseMobChargingEntity(EntityType<CrustoiseMobChargingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
