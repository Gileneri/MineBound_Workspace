...
public class PeblitMobEntity extends Monster {
	public PeblitMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.PEBLIT_MOB.get(), world);
	}

	public PeblitMobEntity(EntityType<PeblitMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
