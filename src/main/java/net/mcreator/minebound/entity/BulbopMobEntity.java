...
public class BulbopMobEntity extends Monster {
	public BulbopMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.BULBOP_MOB.get(), world);
	}

	public BulbopMobEntity(EntityType<BulbopMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
