...
public class MoontantMobEntity extends Monster {
	public MoontantMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.MOONTANT_MOB.get(), world);
	}

	public MoontantMobEntity(EntityType<MoontantMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
