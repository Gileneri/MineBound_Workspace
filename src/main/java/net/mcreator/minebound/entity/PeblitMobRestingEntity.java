...
public class PeblitMobRestingEntity extends Monster {
	public PeblitMobRestingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.PEBLIT_MOB_RESTING.get(), world);
	}

	public PeblitMobRestingEntity(EntityType<PeblitMobRestingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
