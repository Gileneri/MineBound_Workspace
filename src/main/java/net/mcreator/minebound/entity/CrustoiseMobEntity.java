...
public class CrustoiseMobEntity extends Monster {
	public CrustoiseMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.CRUSTOISE_MOB.get(), world);
	}

	public CrustoiseMobEntity(EntityType<CrustoiseMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
