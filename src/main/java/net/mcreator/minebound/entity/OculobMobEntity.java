...
public class OculobMobEntity extends Monster {
	public OculobMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.OCULOB_MOB.get(), world);
	}

	public OculobMobEntity(EntityType<OculobMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
