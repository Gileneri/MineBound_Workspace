...
public class TinticMobEntity extends Monster {
	public TinticMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.TINTIC_MOB.get(), world);
	}

	public TinticMobEntity(EntityType<TinticMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
