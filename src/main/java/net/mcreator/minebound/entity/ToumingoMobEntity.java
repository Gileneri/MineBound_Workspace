...
public class ToumingoMobEntity extends Monster {
	public ToumingoMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.TOUMINGO_MOB.get(), world);
	}

	public ToumingoMobEntity(EntityType<ToumingoMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
