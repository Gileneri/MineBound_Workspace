...
public class AdultPoptopMobEntity extends Monster {
	public AdultPoptopMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.ADULT_POPTOP_MOB.get(), world);
	}

	public AdultPoptopMobEntity(EntityType<AdultPoptopMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
