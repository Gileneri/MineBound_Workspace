...
public class TrictusMobEntity extends Monster {
	public TrictusMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.TRICTUS_MOB.get(), world);
	}

	public TrictusMobEntity(EntityType<TrictusMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
