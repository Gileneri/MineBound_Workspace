...
public class BatongMobEntity extends Monster {
	public BatongMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.BATONG_MOB.get(), world);
	}

	public BatongMobEntity(EntityType<BatongMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
