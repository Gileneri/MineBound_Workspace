...
public class BobotMobChargingEntity extends Monster {
	public BobotMobChargingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.BOBOT_MOB_CHARGING.get(), world);
	}

	public BobotMobChargingEntity(EntityType<BobotMobChargingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
