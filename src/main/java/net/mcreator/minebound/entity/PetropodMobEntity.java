...
public class PetropodMobEntity extends Monster {
	public PetropodMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.PETROPOD_MOB.get(), world);
	}

	public PetropodMobEntity(EntityType<PetropodMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
