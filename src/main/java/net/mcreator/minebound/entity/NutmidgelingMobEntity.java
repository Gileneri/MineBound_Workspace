...
public class NutmidgelingMobEntity extends Monster {
	public NutmidgelingMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.NUTMIDGELING_MOB.get(), world);
	}

	public NutmidgelingMobEntity(EntityType<NutmidgelingMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
