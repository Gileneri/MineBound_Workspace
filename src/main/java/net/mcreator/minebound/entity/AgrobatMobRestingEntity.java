...
public class AgrobatMobRestingEntity extends Monster {
	public AgrobatMobRestingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.AGROBAT_MOB_RESTING.get(), world);
	}

	public AgrobatMobRestingEntity(EntityType<AgrobatMobRestingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
