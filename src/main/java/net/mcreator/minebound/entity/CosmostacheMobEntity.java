...
public class CosmostacheMobEntity extends Monster {
	public CosmostacheMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.COSMOSTACHE_MOB.get(), world);
	}

	public CosmostacheMobEntity(EntityType<CosmostacheMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
