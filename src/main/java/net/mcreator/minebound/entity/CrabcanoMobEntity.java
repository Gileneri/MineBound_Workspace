...
public class CrabcanoMobEntity extends Monster {
	public CrabcanoMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.CRABCANO_MOB.get(), world);
	}

	public CrabcanoMobEntity(EntityType<CrabcanoMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
