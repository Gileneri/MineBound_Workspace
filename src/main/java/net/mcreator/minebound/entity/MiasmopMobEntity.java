...
public class MiasmopMobEntity extends Monster {
	public MiasmopMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.MIASMOP_MOB.get(), world);
	}

	public MiasmopMobEntity(EntityType<MiasmopMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
