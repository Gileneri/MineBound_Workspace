...
public class NutmidgeMobChargingEntity extends Monster {
	public NutmidgeMobChargingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.NUTMIDGE_MOB_CHARGING.get(), world);
	}

	public NutmidgeMobChargingEntity(EntityType<NutmidgeMobChargingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
