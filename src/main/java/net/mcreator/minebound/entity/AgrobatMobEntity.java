...
public class AgrobatMobEntity extends Monster {
	public AgrobatMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.AGROBAT_MOB.get(), world);
	}

	public AgrobatMobEntity(EntityType<AgrobatMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
