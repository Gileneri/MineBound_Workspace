...
public class TentacleClamMobEntity extends Monster {
	public TentacleClamMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.TENTACLE_CLAM_MOB.get(), world);
	}

	public TentacleClamMobEntity(EntityType<TentacleClamMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, -0.15, true) {
			@Override
