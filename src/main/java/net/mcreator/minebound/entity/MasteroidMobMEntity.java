...
public class MasteroidMobMEntity extends Monster {
	public MasteroidMobMEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.MASTEROID_MOB_M.get(), world);
	}

	public MasteroidMobMEntity(EntityType<MasteroidMobMEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
