...
public class GleapMobEntity extends Monster {
	public GleapMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.GLEAP_MOB.get(), world);
	}

	public GleapMobEntity(EntityType<GleapMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
