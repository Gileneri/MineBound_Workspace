...
public class YokatMobEntity extends Monster {
	public YokatMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.YOKAT_MOB.get(), world);
	}

	public YokatMobEntity(EntityType<YokatMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
