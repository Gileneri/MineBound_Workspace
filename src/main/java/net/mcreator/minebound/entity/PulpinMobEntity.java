...
public class PulpinMobEntity extends Monster {
	public PulpinMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.PULPIN_MOB.get(), world);
	}

	public PulpinMobEntity(EntityType<PulpinMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
