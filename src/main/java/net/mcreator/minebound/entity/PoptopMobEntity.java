...
public class PoptopMobEntity extends Monster {
	public PoptopMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.POPTOP_MOB.get(), world);
	}

	public PoptopMobEntity(EntityType<PoptopMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
