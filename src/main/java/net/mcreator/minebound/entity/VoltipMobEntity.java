...
public class VoltipMobEntity extends Monster {
	public VoltipMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.VOLTIP_MOB.get(), world);
	}

	public VoltipMobEntity(EntityType<VoltipMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
