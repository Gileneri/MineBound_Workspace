...
public class SnagglerMobEntity extends Monster {
	public SnagglerMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SNAGGLER_MOB.get(), world);
	}

	public SnagglerMobEntity(EntityType<SnagglerMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 3.2, false) {
			@Override
