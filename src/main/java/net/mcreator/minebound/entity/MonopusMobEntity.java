...
public class MonopusMobEntity extends Monster {
	public MonopusMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.MONOPUS_MOB.get(), world);
	}

	public MonopusMobEntity(EntityType<MonopusMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
