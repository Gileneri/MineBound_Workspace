...
public class PipkinMobEntity extends Monster {
	public PipkinMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.PIPKIN_MOB.get(), world);
	}

	public PipkinMobEntity(EntityType<PipkinMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
