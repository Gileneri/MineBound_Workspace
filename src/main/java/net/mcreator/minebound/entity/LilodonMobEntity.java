...
public class LilodonMobEntity extends Monster {
	public LilodonMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.LILODON_MOB.get(), world);
	}

	public LilodonMobEntity(EntityType<LilodonMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
