...
public class ParatailMobEntity extends Monster {
	public ParatailMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.PARATAIL_MOB.get(), world);
	}

	public ParatailMobEntity(EntityType<ParatailMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.FLYING_SPEED, 0.14);
		return builder;
	}
}
