...
public class FennixMobEntity extends Monster {
	public FennixMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.FENNIX_MOB.get(), world);
	}

	public FennixMobEntity(EntityType<FennixMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
