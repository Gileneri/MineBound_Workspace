...
public class IguarmorMobEntity extends Monster {
	public IguarmorMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.IGUARMOR_MOB.get(), world);
	}

	public IguarmorMobEntity(EntityType<IguarmorMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
