...
public class ScandroidMobChargingEntity extends Monster {
	public ScandroidMobChargingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SCANDROID_MOB_CHARGING.get(), world);
	}

	public ScandroidMobChargingEntity(EntityType<ScandroidMobChargingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
