...
public class CrutterMobEntity extends Monster {
	public CrutterMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.CRUTTER_MOB.get(), world);
	}

	public CrutterMobEntity(EntityType<CrutterMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
