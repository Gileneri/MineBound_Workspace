...
public class MasteroidMobLEntity extends Monster {
	public MasteroidMobLEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.MASTEROID_MOB_L.get(), world);
	}

	public MasteroidMobLEntity(EntityType<MasteroidMobLEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
