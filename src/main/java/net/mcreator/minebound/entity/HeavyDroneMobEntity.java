...
public class HeavyDroneMobEntity extends Monster {
	public HeavyDroneMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.HEAVY_DRONE_MOB.get(), world);
	}

	public HeavyDroneMobEntity(EntityType<HeavyDroneMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
