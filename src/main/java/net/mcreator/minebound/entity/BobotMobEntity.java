...
public class BobotMobEntity extends Monster {
	public BobotMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.BOBOT_MOB.get(), world);
	}

	public BobotMobEntity(EntityType<BobotMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
