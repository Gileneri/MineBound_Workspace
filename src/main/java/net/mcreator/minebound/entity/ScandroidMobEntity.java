...
public class ScandroidMobEntity extends Monster {
	public ScandroidMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SCANDROID_MOB.get(), world);
	}

	public ScandroidMobEntity(EntityType<ScandroidMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 2.2, false) {
			@Override
