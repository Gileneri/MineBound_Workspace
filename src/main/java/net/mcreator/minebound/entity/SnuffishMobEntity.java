...
public class SnuffishMobEntity extends Monster {
	public SnuffishMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SNUFFISH_MOB.get(), world);
	}

	public SnuffishMobEntity(EntityType<SnuffishMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
