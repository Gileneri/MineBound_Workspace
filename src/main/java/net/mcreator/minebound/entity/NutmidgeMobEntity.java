...
public class NutmidgeMobEntity extends Monster {
	public NutmidgeMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.NUTMIDGE_MOB.get(), world);
	}

	public NutmidgeMobEntity(EntityType<NutmidgeMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
