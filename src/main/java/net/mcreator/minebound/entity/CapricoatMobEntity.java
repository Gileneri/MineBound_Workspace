...
public class CapricoatMobEntity extends Monster {
	public CapricoatMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.CAPRICOAT_MOB.get(), world);
	}

	public CapricoatMobEntity(EntityType<CapricoatMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
