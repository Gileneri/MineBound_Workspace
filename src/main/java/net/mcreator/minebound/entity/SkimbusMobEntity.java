...
public class SkimbusMobEntity extends Monster {
	public SkimbusMobEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.SKIMBUS_MOB.get(), world);
	}

	public SkimbusMobEntity(EntityType<SkimbusMobEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.FLYING_SPEED, 0.16);
		return builder;
	}
}
