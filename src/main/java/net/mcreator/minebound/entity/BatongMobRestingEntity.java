...
public class BatongMobRestingEntity extends Monster {
	public BatongMobRestingEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MineboundModEntities.BATONG_MOB_RESTING.get(), world);
	}

	public BatongMobRestingEntity(EntityType<BatongMobRestingEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
